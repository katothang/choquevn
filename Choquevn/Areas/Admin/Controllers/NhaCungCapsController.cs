...
{
    public class NhaCungCapsController : AdminController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TenNhaCungCap")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TenNhaCungCap")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
